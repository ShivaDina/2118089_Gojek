  ...
  return (
    <View style={home.container}>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>13 November, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>ITN Kampus 2, Tasikmadu</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp30.000</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>19 Oktober, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={scooter}
            style={home.icon}
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Kopstup LA. Sucipto</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp16.000</Text>
          </View>
        </View>
      </View>
    </View>
